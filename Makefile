...
CharLine.o : $(USER_DIR)/CharLine.cpp $(USER_DIR)/CharLine.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/CharLine.cpp

test.o : $(USER_DIR)/test.cpp $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/test.cpp

test_unittest : CharLine.o test.o gtest_main.a
